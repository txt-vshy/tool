...
## Modified By airium
## Blog: https://fastgit.hanada.info/airium
## Modified By 王煎饼
## Github: https://fastgit.hanada.info/bin456789/
## Modified By nat.ee
...
# Reference: https://fastgit.hanada.info/airium/Linux-Reinstall/blob/master/install-raid0.sh
...
#            https://fastgit.hanada.info/office-itou/Linux/blob/master/installer/source/preseed_debian.cfg
...
function DebianModifiedPreseed() {
  if [[ "$linux_relese" == 'debian' ]] || [[ "$linux_relese" == 'kali' ]]; then
    debianConfFileDir="https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Debian"
...
# Reference: https://fastgit.hanada.info/fail2ban/fail2ban/issues/2756
...
# Reference: https://netboot.xyz/docs/booting/grub
  if [[ "$IsCN" == "cn" ]]; then
    ...
    NetbootXyzGrub="https://fastgit.hanada.info/raw/formorer/grub-imageboot/master/bin/60_grub-imageboot"
  fi
...
# https://fastgit.hanada.info/iesplin/kali-preseed/blob/master/preseed/core-minimal.cfg
#
...
# Enable IPv6
  ...
  if [[ "$setAutoConfig" == "1" ]]; then
    ...
    if [[ "$IsCN" == "cn" ]]; then
      ...
      alpineInstallOrDdAdditionalFiles "https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Alpine/alpineInit.sh" "https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Alpine/network/resolv.conf" "https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Alpine/motd.sh" "archive.ubuntu.com" "ports.ubuntu.com" "https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Ubuntu/ubuntuInit.sh" "https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Windows/windowsInit.sh" "https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Windows/SetupComplete.bat" "https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/RedHat/RHELinit.sh" "security.ubuntu.com"
    fi
...
# https://cloudinit.readthedocs.io/en/latest/howto/disable_cloud_init.html
    ...
    alpineNetcfgMirror="https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Alpine/network/"
    [[ "$targetRelese" == 'Ubuntu' ]] && { ubuntuCloudinitMirrorCn="https://gitee.com/mb9e8j2/Tools/raw/master/Linux_reinstall/Ubuntu/CloudInit/"; ubuntuCloudinitMirror="https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/Ubuntu/CloudInit/"; }
    [[ "$targetRelese" == 'AlmaLinux' || "$targetRelese" == 'Rocky' ]] && { rhelCloudinitMirrorCn="https://gitee.com/mb9e8j2/Tools/raw/master/Linux_reinstall/RedHat/CloudInit/"; rhelCloudinitMirror="https://fastgit.hanada.info/raw/leitbogioro/Tools/master/Linux_reinstall/RedHat/CloudInit/"; }
    if [[ "$IPStackType" == "IPv4Stack" ]]; then
      if [[ "$Network4Config" == "isDHCP" ]]; then
        if [[ "$IsCN" == "cn" ]]; then
